...
type Vanitynumber struct {
	...
	MinutesUsed float32 `json:"minutes_used,omitempty"`

	// The amount of minutes included with the vanity number before billed additionally.
	MinutesAllowed float32 `json:"minutes_allowed,omitempty"`

	// The amount of voicemails that have not been downloaded.
	VoicemailsNew int32 `json:"voicemails_new,omitempty"`

	// The amount of voicemails that have been downloaded.
	VoicemailsOld int32 `json:"voicemails_old,omitempty"`
